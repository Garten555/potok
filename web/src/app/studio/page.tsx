...
import {
  StudioContentView,
  type EditVideoFieldErrors,
  type StudioContentItem,
} from "@/components/studio/studio-content-view";
import {
  StudioPlaylistsView,
  type PlaylistVideoDetail,
  type StudioPlaylistRow,
  type StudioVideoPickRow,
} from "@/components/studio/studio-playlists-view";
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <label className="block space-y-1">
                    ...
                    {uploadFieldErrors.title ? (
                      <span className="text-xs text-rose-300">{uploadFieldErrors.title}</span>
                    ) : null}
                  </label>
                  <label className="block space-y-1">
                  ...
                  <label className="block space-y-1">
                    ...
                    {uploadFieldErrors.tags ? (
                      <span className="text-xs text-rose-300">{uploadFieldErrors.tags}</span>
                    ) : null}
                  </label>
                  <label className="block space-y-1">
