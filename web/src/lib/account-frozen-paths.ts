...
const ALLOWED_WHEN_FROZEN_PREFIXES = ["/account/frozen", "/auth", "/rules", "/privacy", "/offer"] as const;
...
const ALLOWED_WHEN_MODERATION_SUSPENDED = [
  "/account/moderation-suspended",
  "/auth",
  "/rules",
  "/privacy",
  "/offer",
