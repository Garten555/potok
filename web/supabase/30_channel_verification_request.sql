-- Заявка автора на верификацию канала: текст в студии, рассмотрение в админке.
...
comment on column public.users.channel_verification_request_message is 'Текст заявки на верификацию канала (от автора).';
comment on column public.users.channel_verification_request_at is 'Когда отправлена заявка.';
comment on column public.users.channel_verification_request_status is 'none | pending | rejected; после одобрения верификации — none, смотрим channel_verified.';
